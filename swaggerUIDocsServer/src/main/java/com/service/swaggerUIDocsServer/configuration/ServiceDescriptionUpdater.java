package com.service.swaggerUIDocsServer.configuration;
...
public class ServiceDescriptionUpdater {
    ...
    public ServiceDescriptionUpdater(DiscoveryClient discoveryClient, ServiceDefinitionContext definitionContext){
    ...
    public void refreshSwaggerConfigurations(){
        ...
        discoveryClient.getServices().forEach(serviceId -> {
            ...
            if(serviceInstances == null || serviceInstances.isEmpty()){ //Should not be the case kept for failsafe
                ...
                System.out.println("URLSwagger = " + swaggerURL);
